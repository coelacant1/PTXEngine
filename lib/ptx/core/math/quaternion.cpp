...
ptx::UString Quaternion::ToString() const {
    ptx::UString w = Mathematics::DoubleToCleanString(this->W);
    ptx::UString x = Mathematics::DoubleToCleanString(this->X);
    ptx::UString y = Mathematics::DoubleToCleanString(this->Y);
    ptx::UString z = Mathematics::DoubleToCleanString(this->Z);
