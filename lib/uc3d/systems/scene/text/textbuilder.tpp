...
TextBuilder<lineCount, characterWidth>::TextBuilder(bool isEfficient) {
...
template<uint8_t lineCount, uint8_t characterWidth>
TextBuilder<lineCount, characterWidth>::TextBuilder(Vector2D size, Vector2D position, uint16_t blinkTime, bool isEfficient) {
    this->size = size;
...
template<uint8_t lineCount, uint8_t characterWidth>
void TextBuilder<lineCount, characterWidth>::SetMaterial(Material* material) {
    this->material = material;
}

template<uint8_t lineCount, uint8_t characterWidth>
void TextBuilder<lineCount, characterWidth>::SetSize(Vector2D size) {
    this->size = size;
}

template<uint8_t lineCount, uint8_t characterWidth>
void TextBuilder<lineCount, characterWidth>::SetPositionOffset(Vector2D positionOffset) {
    this->positionOffset = positionOffset;
}

template<uint8_t lineCount, uint8_t characterWidth>
void TextBuilder<lineCount, characterWidth>::SetRotationOffset(Vector2D rotationOffset) {
    this->rotationOffset = rotationOffset;
}

template<uint8_t lineCount, uint8_t characterWidth>
void TextBuilder<lineCount, characterWidth>::SetRotationAngle(float rotationAngle) {
    this->rotationAngle = rotationAngle;
}

template<uint8_t lineCount, uint8_t characterWidth>
void TextBuilder<lineCount, characterWidth>::SetBlinkTime(uint16_t blinkTime) {
    this->blinkTime = blinkTime;
}

template<uint8_t lineCount, uint8_t characterWidth>
void TextBuilder<lineCount, characterWidth>::SetText(uint8_t line, uc3d::UString value, bool centerText) {
...
template<uint8_t lineCount, uint8_t characterWidth>
void TextBuilder<lineCount, characterWidth>::ClearText() {
...
template<uint8_t lineCount, uint8_t characterWidth>
RGBColor TextBuilder<lineCount, characterWidth>::GetRGB(const Vector3D& position, const Vector3D& normal, const Vector3D& uvw) {
