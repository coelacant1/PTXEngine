...
uc3d::UString RGBColor::ToString() {
    uc3d::UString r = Mathematics::DoubleToCleanString(this->R);
    uc3d::UString g = Mathematics::DoubleToCleanString(this->G);
    uc3d::UString b = Mathematics::DoubleToCleanString(this->B);
