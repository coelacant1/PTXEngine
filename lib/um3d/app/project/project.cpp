...
Project::Project(CameraManager* cameras, uint8_t numObjects) 
    ...
    previousAnimationTime = um3d::Time::Micros();
    previousRenderTime = um3d::Time::Micros();
    previousDisplayTime = um3d::Time::Micros();
}
...
void Project::RenderEndTimer() {
    renderTime = ((float)(um3d::Time::Micros() - previousRenderTime)) / 1000000.0f;
}
...
void Project::Animate(float ratio) {
    ...
    animationTime = ((float)(um3d::Time::Micros() - previousAnimationTime)) / 1000000.0f;
}
...
void Project::Display() {
    ...
    displayTime = ((float)(um3d::Time::Micros() - previousDisplayTime)) / 1000000.0f;
}
