...
um3d::UString RGBColor::ToString() {
    um3d::UString r = Mathematics::DoubleToCleanString(this->R);
    um3d::UString g = Mathematics::DoubleToCleanString(this->G);
    um3d::UString b = Mathematics::DoubleToCleanString(this->B);
