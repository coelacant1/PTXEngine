...
um3d::UString Quaternion::ToString() const {
    um3d::UString w = Mathematics::DoubleToCleanString(this->W);
    um3d::UString x = Mathematics::DoubleToCleanString(this->X);
    um3d::UString y = Mathematics::DoubleToCleanString(this->Y);
    um3d::UString z = Mathematics::DoubleToCleanString(this->Z);
