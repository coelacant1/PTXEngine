...
#include "../assets/mesh/trianglegroup.hpp"
#include "../assets/mesh/statictrianglegroup.hpp"
...
public:
     ...
     */
    Mesh(IStaticTriangleGroup* originalTriangles, ITriangleGroup* modifiedTriangles, Material* material);
