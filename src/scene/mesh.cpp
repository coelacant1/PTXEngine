#include "../../include/um3d/scene/mesh.hpp"

Mesh::Mesh(IStaticTriangleGroup* originalTriangles, ITriangleGroup* modifiedTriangles, Material* material) : originalTriangles(originalTriangles), modifiedTriangles(modifiedTriangles) {
